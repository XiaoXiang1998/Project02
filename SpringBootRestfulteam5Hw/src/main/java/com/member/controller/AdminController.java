...
/*--------------------------------------------------基本操作--------------------------------------------------*/
	...
	public ResponseEntity<String> insertAction(@RequestParam("account") String account, @RequestParam("password") String password,
			...
			@RequestParam("photoSticker") MultipartFile mf)
		...
		if (fileName != null && fileName.length() > 0) {
			...
			String photoSticker = "UsersPic/" + newFileName;

			AdminBean adBean = new AdminBean(account, password, email, phone, name, gender, address, photoSticker,hiredate);
	...
	public ResponseEntity<String> updateAdminAction(@RequestParam("aid") Integer aid,
		...
		if (fileName != null && fileName.length() > 0) {
			...
			/*------------------------------------------------------------------------------------------------------------------------------*/
			AdminBean adBean = new AdminBean(aid,account,password,email,phone,name,gender,address,photo_sticker,hiredate);
