...
<!-- 					</div> -->
            ...
            %>
				...
				<td><%=appeals.getAppeals_name()%></td>
				<td><%=appeals.getAppeals_content()%></td>
				<td><%=appeals.getAppeals_reason()%></td>
				<td><%=appeals.getAppeals_order()%></td>
				<td><%=appeals.getAppeals_date()%></td>
				<td><%=appeals.getAppeals_other()%></td>
				<td><%=appeals.getAppeals_state()%></td>
				<td><a class="btn2" href="/appeals/update/<%=appeals.getAppeals_id()%>">修改</a></td>
				<td><a class="btn1" href="/appeals/delete/<%=appeals.getAppeals_id()%>">刪除</a> </td>
