...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <h1 class="mb-4">申訴資料</h1>
                                        <form method="post" action="/updatecontroller2">
    ...
    <label for="inputPassword">相關證據</label>
                                            ...
                                            <div class="form-floating mb-3">
                                               <td>
   												<div class="form-floating mb-3">
                                                <input class="form-control" id="inputPassword" type="text"   name="appeals_state"   readonly  value="${appeals.appeals_state}"/>
...
<!--                                             </div> -->
                                ...
                                class="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary"  value="send">更新</button>
