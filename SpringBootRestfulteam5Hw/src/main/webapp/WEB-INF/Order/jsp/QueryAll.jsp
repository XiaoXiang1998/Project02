			...
			<div class="row justify-content-center align-items-center h-100">
				<div class="col-md-6 border p-4">
					...
					<form id="editOrderForm" action="updateOrder.controller"
						...
						<div class="mb-3">
							<label for="editShippingName" class="form-label">收件人姓名:</label> <input
								type="text" id="editShippingName" name="name"
								class="form-control">
						</div>
						<div class="mb-3">
							<label for="editShippingTel" class="form-label">收件人電話:</label> <input
						...
						<div class="mb-3">
							<label for="editOrderStatus" class="form-label">訂單狀態:</label> <select
						...
						<button type="button" class="btn btn-primary"
							onclick="confirmSave()">保存</button>
						<button type="button" class="btn btn-secondary"
							onclick="hideEditForm()">取消</button>
					</form>
				</div>
			</div>
		</div>
		<div class="footer mt-3 text-center">
			<c:choose>
				<c:when test="${not empty orders}">
					<p class="fs-5 fw-bold">共有 ${fn:length(orders)} 筆訂單</p>
				</c:when>
				<c:otherwise>
