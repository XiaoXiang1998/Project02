...
<body style='background-color: fdf5e6'>
		...
		<table border="1">
			...
			<tr>
				...
				<td>
					...
					%> <img src="${pageContext.request.contextPath}/commentPicture/output.png" alt="star" width="20" height="20">
					<%
					}
					%> <%
 ...
 %>
				...
				<td>
					<form id="deleteForm"
							action="${pageContext.request.contextPath}/comment/<%=com.getCommentId()%>"
						method="post">
						<!-- 修改为DELETE方法 -->
