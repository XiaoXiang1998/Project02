...
<div class="row">
    <div class="col">
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="?rating=0">全部 (${totalCommentsCount})</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?rating=5">5顆星 (${ratingCounts[4]})</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?rating=4">4顆星 (${ratingCounts[3]})</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?rating=3">3顆星 (${ratingCounts[2]})</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?rating=2">2顆星 (${ratingCounts[1]})</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?rating=1">1顆星 (${ratingCounts[0]})</a>
            </li>
        </ul>
    </div>
</div>
    ...
    <c:forEach var="comment" items="${comments}">
        <div class="comment">
            ...
            <div class="time-and-details">
                ...
                <p class="order-details"><span class="separator">|</span></p>
                <!-- 获取规格尺寸 -->
    ...
    <ul>
        <c:forEach var="i" begin="1" end="${totalPages}">
            <li class="page-item ${currentPage == i-1 ? 'active' : ''}">
                <a class="page-link" href="?page=${i-1}&rating=${selectedRating}">${i}</a>
            </li>
        </c:forEach>
    </ul>
</div>
