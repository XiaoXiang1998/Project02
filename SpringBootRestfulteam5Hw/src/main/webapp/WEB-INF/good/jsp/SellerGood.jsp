<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            ...
            <!-- Fruits Shop Start-->
            <!-- 得到的資訊 -->
            <div id="searchGoodName">
                <c:forEach var="i" begin="0" end="${goodNumber}" step="1">
                    <p>${good[i].goodsID}</p>
                    <p>${good[i].goodsType}</p>
                    <p>${good[i].launchDate}</p>
                    <p>${good[i].brand}</p>
                    <p>${good[i].shipmentPlace}</p>
                </c:forEach>
            </div>
