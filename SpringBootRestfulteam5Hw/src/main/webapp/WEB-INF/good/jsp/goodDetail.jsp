        ...
        <<<<<<< HEAD <head>
            ...
            <head>
                ...
                <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css"
                    rel="stylesheet">
                <link href="../../frontlib/lightbox/css/lightbox.min.css" rel="stylesheet">
                >>>>>>> aafcd989ae90d2d403594d24944483ad89c90b5c
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            ...
                                            <ul class="list-group" style="max-height: 615px; overflow-y: auto;">
                                                <c:forEach var="notification" items="${notifications}" varStatus="loop">
                                                    ...
                                                    <li><a class="nav-link dropdown-item fs-md ${notification.reads == 1 ? 'text-muted' : 'fw-bold'}"
                                                                ...
                                                                <c:forEach var="j" begin="0" end="${GoodImageNumber}"
                                                                    ...
                                                                    <div>
                                                                        <img class="img-fluid w-100"
                                                                            src="${j.imagePath}" alt="${j.imagePath}"
                                                                            style="height: 400px;">
                                                                    </div>
                                                                </c:forEach>
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="row row-cols-2">
                                                                <c:forEach var="j" begin="0" end="${GoodFormatNumber}"
                                                                    ...
                                                                    <div class="col">
                                                                        <button
                                                                            class="btn btn-outline-primary round-pill CategoryItem w-100 mb-1">
                                                                            <img src="${j.goodImagePath}"
                                                                                alt="${j.goodImagePath}"
                                                                                style="width: 20px;height: 20px;">
                                                                            <span>${j.goodSize}</span>
                                                                            <span hidden
                                                                                class="CategoryPrice">${j.goodPrice}</span>
                                                                            <span hidden
                                                                                class="CategoryNumber">${j.goodsStock}</span>
                                                                            <span hidden
                                                                                class="formatID">${j.good.goodsID}</span>
                                                                        </button>
                                                                    </div>
                                                                </c:forEach>
                                                            </div>
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="col">
                                                                    <form action="" id="orderDetail">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            id="orderNumber" name="orderNumber" hidden>
                                                                        <!-- 購買數量 -->
                                                                        <input type="text" class="form-control"
                                                                            id="orderformatID" name="orderformatID"
                                                                            hidden>
                                                                        <!-- 規格表編號 -->
                                                                        <input type="text" class="form-control"
                                                                            id="buyerorderID" name="buyerorderID"
                                                                            hidden>
                                                                        <!-- 買家編號 -->
                                                                        <button type="button"
                                                                            id="GoToOrder">去結帳</button>
                                                                    </form>
                                                                </div>
                                                                <div class="col">
                                                                    <form action="" id="cartDetail">
                                                                        <!-- 進入購物車(透過ajax將值傳到後端) -->
                                                                        <input type="text" class="form-control"
                                                                            id="cartNumber" name="cartNumber" hidden>
                                                                        <!-- 購買數量 -->
                                                                        <input type="text" class="form-control"
                                                                            id="cartformatID" name="cartformatID"
                                                                            hidden> <!-- 規格表編號 -->
                                                                        <input type="text" class="form-control"
                                                                            id="buyercartID" name="buyercartID" hidden>
                                                                        <!-- 買家編號 -->
                                                                        <button type="button"
                                                                            id="GoToCart">加入購物車</button>
                                                                    </form>
                                                                </div>
                                                                <!-- 商品圖片(用輪播呈現) -->
                                                                =======
                                                                ...
                                                                <form action="" id="orderDetail">
                                                                    ...
                                                                    <!-- 購買數量 -->
                                                                    <input type="text" class="form-control"
                                                                        id="formatID" name="formatID" hidden>
                                                                    <!-- 規格表編號 -->
                                                                    <input type="text" class="form-control"
                                                                        id="formatID" name="formatID" hidden>
                                                                    <!-- 買家編號 -->
                                                                            ...
                                                                            <c:forEach var="post" items="${posts}">
                                                                                <div class="d-flex">
                                                                                    ...
                                                                                    <div class="">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div
                                                                                                class="time-and-details">
                                                                                                <c:if
                                                                                                    test="${not empty post.commenttime}">
                                                                                                    <fmt:formatDate
                                                                                                        value="${post.commenttime}"
                                                                                                ...
                                                                                                <p
                                                                                                    class="order-details">
                                                                                                    商品名稱:
                                                                                                    ${post.orders.formatgoodId.good.goodsName}
                                                                                                </p>
                                                                                            </div>
                                                                                        </div>
                                                                                        <p>
                                                                                            <c:out
                                                                                                value="${post.commentcontent}" />
                                                                                        </p>
                                                                                        <!-- 評論內容 -->
                                                                                    </div>
                                                                                </div>
                                                                                <div>
                                                                                    ...
                                                                                    <c:forEach var="i" begin="0"
                                                                                        ...
                                                                                        <a
                                                                                            href="?GoodID=${Good.goodsID}&page=${i}">${i
                                                                                            + 1}</a>
                                                                                    </c:forEach>
                                                                                </div>
                                                                            </c:forEach>
                                                    ...
                                                    <div class="col-lg-3 col-md-6">
                                                        <div class="d-flex flex-column text-start footer-item">
                                                            ...
                                                            <a class="btn-link" href="">About Us</a> <a class="btn-link"
                                                                href="">Contact Us</a> <a class="btn-link"
                                                                href="">Privacy
                                                    ...
                                                    <div class="col-lg-3 col-md-6">
                                                        <div class="d-flex flex-column text-start footer-item">
                                                            ...
                                                            <a class="btn-link" href="">My Account</a> <a
                                                                ...
                                                                class="btn-link" href="">Order History</a> <a
                                                                class="btn-link" href="">International
                                                                Orders</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 col-md-6">
            ...
            if (ItemNumber <= Number(goodstock)) { $('#errormsg').prop("innerHTML", "" );//將錯誤訊息抹消 } if (ItemNumber <=1)
                { $(this).closest('div').find( 'input[id="BuyNumber"]' ).prop("value", 1);//最少購買一筆 } }) </script>
                </body>
                >>>>>>> aafcd989ae90d2d403594d24944483ad89c90b5c
