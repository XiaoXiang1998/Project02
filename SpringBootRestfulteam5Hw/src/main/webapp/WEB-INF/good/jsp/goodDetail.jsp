		...
		<div class="container">
				...
				<div class="col-lg-12 col-xl-12">
					<div class="row g-4">
						<div class="col-lg-6">
							...
							<div class="input-group quantity mb-3 d-flex" id="BuyItemNumber"
								hidden>
								<!--買入數量  -->
								...
								<div class="col">
									...
									<form action="DirectlyBuy" id="orderDetail">
										...
										<input type="text" class="form-control" id="orderGoodSize"
											name="orderGoodSize">
										<!-- 商品尺寸 -->
										<button type="submit" id="GoToOrder"
										...
										<c:if test="${not empty post.productphoto}">
											<div class="comment-photos">
												<img src="${post.productphoto}"
													...
													style="width: 100px; height: 100px;" alt="comment photo">
											</div>
										</c:if>
									</div>
								</div>
					...
					<div class="col-3 card" style="height: 25rem;">
						<form>
							<img class="card-img-top" src="${j.titleImage}"
								alt="${j.titleImage}" style="height: 18rem;"> <input
								type="text" value="${j.goodsID}" name="GoodID" hidden>
							<div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="footer-item">
								...
								<p class="mb-4">typesetting, remaining essentially
									unchanged. It was popularised in the 1960s with the like Aldus
					...
					<div class="row">
						<div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							<span class="text-light"> <a href="#"> <i
									class="fas fa-copyright text-light me-2"></i> Your Site Name
			...
			<script>
				...
				function bindClickHandlers() {
					...
					$('#nav-tab').off('click').on('click', '.nav-link',
							handleClick);
				}
