<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@page import="com.member.model.MemberBean" %>
        ...
        <head>
            <meta charset="BIG5">
            <title>modifyPageTemplete</title>
                ...
                <% HttpSession MemberSession=request.getSession(); MemberBean member=(MemberBean)
                    ...
                    <div class="container-fluid py-5">
                        <div class="container py-5">
                            <h1 class="mb-4">修改商品</h1>
                            <div id="GoodsID" hidden>${goodID}</div> <!-- 裡面放的是商品編號 -->
                            <form id="GoodData" action="goodModify.controller" method="post"
                                enctype="multipart/form-data">
                                <div class="row g-5">
                                    <div class="col-md-12 col-lg-12 col-xl-12"> <!-- 資料填入 -->
                                        <fieldset class="border p-2 mb-3">
                                            <!-- 假資料 -->
                                            <input type="checkbox" name="GoodDelete" class="form-check-input" checked
                                                value="-1" hidden>
                                            <input type="text" name="DeleteFormatDataById" class="form-control"
                                                value="-1" hidden>
                                            <!--  -->
                                            <input type="text" class="form-control" value="" name="GoodsID"
                                                id="GoodsIDFromController" hidden>
                                            <legend class="float-none w-auto">商品圖片</legend>
                                            <div class="form-group" id="GoodPhoto">
                                                <button type="button" class="btn btn-primary"
                                                    id="insertPhoto">新增圖片</button>
                                                <div id="photoData">
                                                </div>
                                                ...
                                                <div id="hiddenGoodImageData" hidden>
                                                    <!--  -->
                                                    <input type="text" class="form-control" value="-1" name="GoodDelete"
                                                        hidden>
                                                    <!--  -->
                                                </div>
                                            </div>
                                        ...
                                        <fieldset class="border p-2 mb-3">
                                            ...
                                            <div class="form-group" id="GoodBasic">
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="text" name="GoodsType" class="form-control"
                                                        id="GoodsType" value="">
                                                ...
                                                <div class="form-floating mb-3">
                                                    <input type="text" name="ShipmentPlace" class="form-control"
                                                        id="ShipmentPlace" value="">
                                                    <label for="ShipmentPlace">出貨地</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <img src="" alt="" data-name="titleImagetarget"
                                                        id="TitleImageTarget">
                                                    <input type="file" name="TitleImage" class="form-control"
                                                        id="TitleImage" value="">
                                                ...
                                                <input type="text" name="GoodDirection" class="form-control"
                                                    id="GoodDirection" value="" hidden>
                                            </div>
                                        </fieldset>
                                        <!--  -->
                                        <fieldset class="border p-2">
                                            ...
                                            <div class="form-group" id="GoodFormat">
                                                ...
                                                <div class="row" id="DeleteFormatDataTransfer">
                                                    <!-- 當有規格資料被刪除時 規格表編號會被丟進這裡 -->
                                                </div>
                                            </div>
                                        </fieldset>
                                        <button type="button" class="btn btn-primary"
                                            id="outputGoodData">Submit</button>
                                        <!--  -->
                                    </div>
