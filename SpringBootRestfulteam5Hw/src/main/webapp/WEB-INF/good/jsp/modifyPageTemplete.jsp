<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">修改商品</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="#">我的商品</a></li>
                <li class="breadcrumb-item"><a href="#">新增商品</a></li>
                <li class="breadcrumb-item active text-white">修改商品</li>
            </ol>
        </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12"> <!-- 資料填入 -->
                            <fieldset class="border p-2 mb-3">
                                ...
                                <input type="checkbox" name="GoodDelete" class="form-check-input" checked value="-1"
                                    hidden>
                                <input type="text" name="DeleteFormatDataById" class="form-control" value="-1" hidden>
                                <!--  -->
