		...
		<body>
			<%@ include file="../FrontDeskNav.jsp" %>
				<% HttpSession MemberSession=request.getSession(); MemberBean member=(MemberBean)
					MemberSession.getAttribute("member"); boolean isSeller=member.isSeller(); %>
							...
							<div class="col-md-3">
								<div class="list-group" id="list-tab" role="tablist">
									...
									<a class="list-group-item list-group-item-action" id="list-account-list"
										...
										aria-controls="account">帳號詳情</a> <a
										class="list-group-item list-group-item-action" id="list-password-list"
										data-bs-toggle="list" href="#list-password" role="tab"
										aria-controls="password">修改密碼</a>
									<a class="list-group-item list-group-item-action" id="Buy-list-orders-list"
										data-bs-toggle="list" href="#Buy-list-orders" role="tab"
										aria-controls="orders">買家訂單</a>
									<a class="list-group-item list-group-item-action" id="Sell-list-orders-list"
										data-bs-toggle="list" href="#Sell-list-orders" role="tab"
									...
									<% if (isSeller) { %>
										<a class="list-group-item list-group-item-action" id="list-managereplies-list"
											href="sellerComments" role="tab">管理回覆</a>
										<a class="list-group-item list-group-item-action" id="list-myreply-list"
											href="repliedComments" role="tab">查看回覆</a>
										<% } else { %>
											<a class="list-group-item list-group-item-action" id="list-comments-list"
												href="userComments" role="tab">查看評論</a> <a
											...
											<% } %>
												...
												<a class="list-group-item list-group-item-action"
													...
													role="tab">我的商品</a>
												<a class="list-group-item list-group-item-action" id="list-appeals-list"
													href="Crudindex" role="tab">申訴頁面</a>

												<a class="list-group-item list-group-item-action" id="list-talk-list"
													href="chat" role="tab">聊聊</a>
								</div>
							</div>
							<div class="col-md-9">
									...
									<div class="tab-pane fade bordered-pane" id="list-account" role="tabpanel"
										...
										<div class="form-floating mb-3 mt-5">
											<input type="text" class="form-control" id="isSeller" placeholder="是否具有賣家身分"
												readonly> <label for="isSeller">是否具有賣家身分</label>
										</div>
										<div class="form-floating mb-3 mt-3">
											<input type="text" class="form-control" id="reviewCount" placeholder="被評論總數"
												readonly> <label for="reviewCount">被評論總數</label>
										</div>
										<div class="form-floating mb-3 mt-3">
										...
										<div class="form-floating mb-3 mt-3">
											<input type="text" class="form-control" id="registrationTime"
												placeholder="註冊時間" readonly> <label for="registrationTime">註冊時間</label>
										</div>
									</div>
									<!-- 修改密碼 -->
										...
										<form action="" method="post" onsubmit="return validateForm()">
											<div class="form-floating mb-3 mt-5">
												<input type="password" class="form-control" id="floatingPassword"
													placeholder="請輸入密碼"> <label for="floatingPassword">請輸入密碼</label>
											</div>
											<div class="form-floating mb-3 mt-3">
												<input type="password" class="form-control" id="floatingCheckPassword"
													placeholder="請再確認密碼"> <label
									...
									<div class="tab-pane fade" id="Buy-list-orders" role="tabpanel"
										...
										<nav>
											<div class="nav nav-tabs" id="nav-tab" role="tablist">
												<button class="nav-link active" id="nav-all-tab" data-bs-toggle="tab"
													...
													aria-controls="nav-all" aria-selected="true">全部</button>
										...
										<div class="tab-content" id="nav-tabContent">
											<div class="tab-pane fade show active" id="nav-all" role="tabpanel"
												aria-labelledby="nav-all-tab"></div>
									...
									<div class="tab-pane fade" id="Sell-list-orders" role="tabpanel"
										...
										<nav>
											<div class="nav nav-tabs" id="nav-tab2" role="tablist">
												<button class="nav-link active" id="nav-all-tab2" data-bs-toggle="tab"
													data-bs-target="#nav-all2" type="button" role="tab"
													aria-controls="nav-all2" aria-selected="true">全部</button>
