							...
							<div class="col-md-3">
								<div class="list-group" id="list-tab" role="tablist">
									...
									<a class="list-group-item list-group-item-action" id="list-comments-list"
										href="userComments" role="tab">查看評論</a>
									<a class="list-group-item list-group-item-action" id="list-buyerreviews-list"
										href="sellerCommentsForUser" role="tab">買家評價</a>
									...
									<a class="list-group-item list-group-item-action" id="list-sellerMarket-list"
										href="sellerMarket" role="tab">我的賣場</a>
									<a class="list-group-item list-group-item-action" id="list-sellerGood-list"
										href="sellerGoodQueryAll" role="tab">我的商品</a>
								</div>
							</div>
							<div class="col-md-9">
