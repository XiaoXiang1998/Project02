		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="tab-content" id="nav-tabContent">
					<!-- 個人資訊 -->
					<div class="tab-pane fade show active bordered-pane" id="list-info" role="tabpanel" aria-labelledby="list-info-list">
						<h3>個人資訊</h3>
						...
						<form action="#" class="mt-3" id="editForm">
							...
							<!-- 新增送出和取消按鈕，預設隱藏 -->
							<div class="d-flex justify-content-center mt-2" id="actionButtons" style="display: none;">
								<button type="button" class="btn btn-success mx-2 controlButton" style="display: none;" id="updateButton">送出</button>
								<button type="button" class="btn btn-danger mx-2 controlButton" style="display: none;" id="cancelButton">取消</button>
							</div>
						</form>
					</div>
					<!-- 帳號詳情 -->
					...
					<!-- 修改密碼 -->
					<div class="tab-pane fade bordered-pane" id="list-password" role="tabpanel" aria-labelledby="list-password-list">
						<h3>修改密碼</h3>
						<form action="" method="post" onsubmit="return validateForm()">
							...
							<div class="d-flex justify-content-center">
								<button type="submit" class="btn btn-primary mt-3" id="changePassword">送出</button>
							</div>
						</form>
					</div>
					<!-- 買家訂單 -->
					<div class="tab-pane fade" id="Buy-list-orders" role="tabpanel" aria-labelledby="Buy-list-orders-list">
						<h3>買家訂單</h3>
						<nav>
							<div class="nav nav-tabs" id="nav-tab" role="tablist">
								<button class="nav-link active" id="nav-all-tab" data-bs-toggle="tab" data-bs-target="#nav-all" type="button" role="tab" aria-controls="nav-all" aria-selected="true">全部</button>
								<button class="nav-link" id="nav-1-tab" data-bs-toggle="tab" data-bs-target="#nav-1" type="button" role="tab" aria-controls="nav-1" aria-selected="false">待出貨</button>
								<button class="nav-link" id="nav-2-tab" data-bs-toggle="tab" data-bs-target="#nav-2" type="button" role="tab" aria-controls="nav-2" aria-selected="false">待收貨</button>
								<button class="nav-link" id="nav-3-tab" data-bs-toggle="tab" data-bs-target="#nav-3" type="button" role="tab" aria-controls="nav-3" aria-selected="false">待評論</button>
								<button class="nav-link" id="nav-4-tab" data-bs-toggle="tab" data-bs-target="#nav-4" type="button" role="tab" aria-controls="nav-4" aria-selected="false">已完成</button>
								<button class="nav-link" id="nav-5-tab" data-bs-toggle="tab" data-bs-target="#nav-5" type="button" role="tab" aria-controls="nav-5" aria-selected="false">已取消</button>
							</div>
						</nav>
						<div class="tab-content" id="nav-tabContent">
					...
					<!-- 賣家訂單 -->
					<div class="tab-pane fade" id="Sell-list-orders" role="tabpanel" aria-labelledby="Sell-list-orders-list">
						<h3>賣家訂單</h3>
						<nav>
							<div class="nav nav-tabs" id="nav-tab2" role="tablist">
								<button class="nav-link active" id="nav-all-tab2" data-bs-toggle="tab" data-bs-target="#nav-all2" type="button" role="tab" aria-controls="nav-all2" aria-selected="true">全部</button>
								<button class="nav-link" id="nav-1-tab2" data-bs-toggle="tab" data-bs-target="#nav-12" type="button" role="tab" aria-controls="nav-12" aria-selected="false">待出貨</button>
								<button class="nav-link" id="nav-2-tab2" data-bs-toggle="tab" data-bs-target="#nav-22" type="button" role="tab" aria-controls="nav-22" aria-selected="false">待收貨</button>
								<button class="nav-link" id="nav-3-tab2" data-bs-toggle="tab" data-bs-target="#nav-32" type="button" role="tab" aria-controls="nav-32" aria-selected="false">待評論</button>
								<button class="nav-link" id="nav-4-tab2" data-bs-toggle="tab" data-bs-target="#nav-42" type="button" role="tab" aria-controls="nav-42" aria-selected="false">已完成</button>
								<button class="nav-link" id="nav-5-tab2" data-bs-toggle="tab" data-bs-target="#nav-52" type="button" role="tab" aria-controls="nav-52" aria-selected="false">已取消</button>
							</div>
						</nav>
						<div class="tab-content" id="nav-tabContent">
							<div class="tab-pane fade show active" id="nav-all2" role="tabpanel" aria-labelledby="nav-all-tab2">.all.</div>
							<div class="tab-pane fade" id="nav-12" role="tabpanel" aria-labelledby="nav-12-tab">.1.</div>
							<div class="tab-pane fade" id="nav-22" role="tabpanel" aria-labelledby="nav-22-tab">.2.</div>
							<div class="tab-pane fade" id="nav-32" role="tabpanel" aria-labelledby="nav-32-tab">.3.</div>
							<div class="tab-pane fade" id="nav-42" role="tabpanel" aria-labelledby="nav-42-tab">.4.</div>
							<div class="tab-pane fade" id="nav-52" role="tabpanel" aria-labelledby="nav-52-tab">.5.</div>
						</div>
					</div>
					<!-- 優惠卷 -->
