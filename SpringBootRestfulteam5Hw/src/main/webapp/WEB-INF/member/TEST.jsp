                    ...
                    <div class="col-md-3">
                        <div class="list-group" id="list-tab" role="tablist">
                            ...
                            <a class="list-group-item list-group-item-action" id="list-account-list"
                                data-bs-toggle="list" href="#list-account" role="tab" aria-controls="account">帳號詳情</a>
                            <a class="list-group-item list-group-item-action" id="list-password-list"
                                data-bs-toggle="list" href="#list-password" role="tab" aria-controls="password">修改密碼</a>
                            <a class="list-group-item list-group-item-action" id="list-orders-list"
                                data-bs-toggle="list" href="#list-orders" role="tab" aria-controls="orders">歷史訂單</a>
                            <a class="list-group-item list-group-item-action" id="list-coupons-list"
                                data-bs-toggle="list" href="#list-coupons" role="tab" aria-controls="coupons">我的優惠券</a>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade show active bordered-pane" id="list-info" role="tabpanel"
                                ...
                                <form action="#" class="mt-3">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingUsername" placeholder="帳號名稱"
                                            readonly>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingPhone" placeholder="手機號碼"
                                            readonly>
                                        <label for="floatingPhone">手機號碼</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingName" placeholder="會員姓名"
                                            readonly>
                                        <label for="floatingName">會員姓名</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <select class="form-select" id="floatingGender" aria-label="會員性別" disabled>
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingAddress" placeholder="會員住址"
                                            readonly>
                            ...
                            <div class="tab-pane fade bordered-pane" id="list-account" role="tabpanel"
                                ...
                                <div class="form-floating mb-3 mt-3">
                                    <input type="text" class="form-control" id="cumulativeScore" placeholder="當前平均評分數"
                                        value="5" readonly>
                                    <label for="cumulativeScore">當前平均評分數</label>
                                </div>
                                <div class="form-floating mb-3 mt-3">
                                    <input type="text" class="form-control" id="totalSalesAmount" placeholder="當前累計消費金額"
                                        value="4350" readonly>
                                    <label for="totalSalesAmount">當前累計消費金額</label>
                                </div>
                                <div class="form-floating mb-3 mt-3">
                                    <input type="text" class="form-control" id="third_party_provider" placeholder="登入方式"
                                        value="一般登入" readonly>
                                    <label for="third_party_provider">登入方式</label>
                                </div>
                                <div class="form-floating mb-3 mt-3">
                                    <input type="text" class="form-control" id="registrationTime" placeholder="註冊時間"
                                        value="2024-04-30" readonly>
